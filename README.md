...
> **Personal note:** I forked this to study how multi-agent LLM systems can be applied to financial analysis. I'm particularly interested in comparing the outputs of the value-oriented agents (Graham, Munger, Buffett) against the growth-oriented ones (Cathie Wood, Phil Fisher) on the same ticker.
